...
const BlogComingSoon = () => {
  return (
    <div className=" h-[80vh] flex flex-col items-center justify-center bg-gradient-to-t from-primary to-white p-6">
      <div className="text-center max-w-2xl">
        ...
        <p className="text-lg text-white/80 mb-8">
          Our blog is under construction. We're working hard to bring you
        ...
        <div className="flex justify-center gap-4">
          ...
          <Link
            href="#"
            className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-primary transition-all"
          >
            Notify Me
          </Link>
        </div>
